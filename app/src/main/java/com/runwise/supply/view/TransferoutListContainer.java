...
public class TransferoutListContainer extends LinearLayout {
    ...
    public void setProductAdapterV2(TransferoutProductAdapter productAdapterV2) {
...
//        ((DefaultItemAnimator) recyclerView2.getItemAnimator()).setSupportsChangeAnimations(false);
    ...
    public TransferoutListContainer(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public void setUpProductRecyclerView() {
        mProductAdapterV2 = new TransferoutProductAdapter(getContext(),false);
