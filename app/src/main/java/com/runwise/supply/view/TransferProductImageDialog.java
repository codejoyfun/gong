...
public class TransferProductImageDialog extends Dialog {
    ...
    public void setListBean(StockProductListResponse.ListBean listBean) {
        mListBean = listBean;
    }

    StockProductListResponse.ListBean mListBean;
...
//                        mCountMap.remove(mListBean);
                    ...
                    EventBus.getDefault().post(new TransferoutProductCountUpdateEvent(mListBean,currentNum));
                }
                break;
...
//                            mCountMap.put(mListBean,value);
                        ...
                        mTvProductCount.setText(value + mListBean.getUom());
                        EventBus.getDefault().post(new TransferoutProductCountUpdateEvent(mListBean,(int)value));
                    }
                });
