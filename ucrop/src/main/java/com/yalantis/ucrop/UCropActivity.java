...
public class UCropActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitleRigthIcon(true, R.drawable.ucrop_ic_done);
        this.findViewById(R.id.left_layout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              onBackPressed();
            }
        });
        this.findViewById(R.id.right_layout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cropAndSaveImage();
            }
...
//            supportInvalidateOptionsMenu();
    ...
    protected void cropAndSaveImage() {
        ...
        mBlockingView.setClickable(true);
        this.setTitleRigthIcon(false, R.drawable.ucrop_ic_done);
