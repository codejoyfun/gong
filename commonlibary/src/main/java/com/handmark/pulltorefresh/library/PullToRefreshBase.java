...
import com.handmark.pulltorefresh.internal.AnimLoadingLayout;
import com.handmark.pulltorefresh.internal.FlipLoadingLayout;
import com.handmark.pulltorefresh.internal.LoadingLayout;
import com.handmark.pulltorefresh.internal.RotateLoadingLayout;
import com.handmark.pulltorefresh.internal.Utils;
import com.handmark.pulltorefresh.internal.ViewCompat;
...
//		mHeaderLayout.setBackgroundColor(Color.parseColor("#ff0000"));
		if (mMode.showHeaderLoadingLayout()) {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case ANIM:
					...
					return new AnimLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
