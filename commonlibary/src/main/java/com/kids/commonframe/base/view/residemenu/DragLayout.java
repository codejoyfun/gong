package com.kids.commonframe.base.view.residemenu;
...
//        ViewHelper.setScaleY(vg_main, f1);
        ViewHelper.setTranslationX(vg_left, -vg_left.getWidth() / 4.3f + vg_left.getWidth() / 4.3f * percent);
...
//        }
        if(followView != null) {
            followView.setBackgroundColor(evaluate(percent,  Color.TRANSPARENT, Color.parseColor("#90000000")));
        }
    }
