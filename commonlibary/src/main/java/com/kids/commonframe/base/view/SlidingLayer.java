...
public class SlidingLayer extends FrameLayout {
    ...
    public SlidingLayer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int shadowRes = ta.getResourceId(R.styleable.SlidingLayer_shadowLayDrawable, -1);
        if (shadowRes != -1) {
            setShadowDrawable(shadowRes);
        }

        // Sets the shadow width
        setShadowWidth((int) ta.getDimension(R.styleable.SlidingLayer_shadowLayWidth, 0));
