 ...
 *
 */
public class IPhotoDraweeView extends DraweeView<GenericDraweeHierarchy> {

  public IPhotoDraweeView(Context context) {
    super(context);
    init();
    inflateHierarchy(context, null);
  }

  public IPhotoDraweeView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
    inflateHierarchy(context, attrs);
  }

  public IPhotoDraweeView(Context context, AttributeSet attrs, int defStyle) {
  ...
  public IPhotoDraweeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  private View.OnLongClickListener mLongClickLitener;
  ...
  public void setController(DraweeController draweeController) {
    ...
    initBase();
//    setImageDrawable(draweeController.getHierarchy().getTopLevelDrawable());
  }
  ...
  private void initBase() {
    ...
    int imgw = (int)(mImageBounds.left+mImageBounds.right);
    int imgh = (int)(mImageBounds.top + mImageBounds.bottom);
...
//    }
    ...
    int drawableW = (int)(mImageBounds.left+mImageBounds.right);
    int drawableH = (int)(mImageBounds.top + mImageBounds.bottom);
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
  ...
  private Runnable mClickRunnable = new Runnable() {
    ...
    public void run() {
      if (mClickListener != null) {
        mClickListener.onClick(IPhotoDraweeView.this);
      }
    }
  };
  ...
  private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onLongPress(MotionEvent e) {
      super.onLongPress(e);
      if ( mLongClickLitener != null ) {
        mLongClickLitener.onLongClick(IPhotoDraweeView.this);
      }
    }
  ...
  protected void onDraw(Canvas canvas) {
    ...
    canvas.concat(mSynthesisMatrix);
    super.onDraw(canvas);
  ...
  @Override
  public void setOnLongClickListener(View.OnLongClickListener mLongClickLitener) {
    super.setOnLongClickListener(mLongClickLitener);
