...
public class ShowPicViewHelper {
    ...
    public ShowPicViewHelper(BaseActivity mContext ,FrameLayout pagerLayout, ImageAdapter viewPagerAdapter,View clickView,View rootView) {
...
//    	thumbView.setAlpha(0f);
    	...
    	viewPager.setOnPageChangeListener(new OnPageChangeListener() {
    		...
    		public void onPageSelected(int position) {
    			...
    			View view  = clickView.findViewWithTag(viewPagerAdapter.getImgUrl(position));
    			if ( view != null ) {
    				initAnim(view);
    			}
    			PhotoView photoView = getViewByPosition(position);
    			if ( photoView != null ) {
    				photoView.setScale(1, false);
    			}
    			setIndicator();
    		}
    		@Override
    ...
    */
    ...
    private PhotoView getViewByPosition(int position) {
    	if ( viewPagerAdapter != null && viewPager != null ) {
    	String url = viewPagerAdapter.getImgUrl(position);
    	return (PhotoView)viewPager.findViewWithTag(url);
    	}
    	return null;
    }
