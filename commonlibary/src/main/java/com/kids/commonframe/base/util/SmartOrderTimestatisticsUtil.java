...
import static com.kids.commonframe.base.util.UmengUtil.EVENT_ID_SMART_ORDER_TIME;
...
public class SmartOrderTimestatisticsUtil {
    ...
    public static void upload(Context context,String content) {
        ...
        MobclickAgent.onEventValue(context, EVENT_ID_SMART_ORDER_TIME, map_value, duration);
    }
    ...
    public static void pause(Context context) {
        if (mStatus == STATUS_START) {
            mElapsedTime = (long) SPUtils.get(context,SPUtils.FILE_KEY_SMART_ORDER_ELAPSED_TIME,0L);
            mElapsedTime += System.currentTimeMillis() - mStartTime;
            SPUtils.put(context,SPUtils.FILE_KEY_SMART_ORDER_ELAPSED_TIME,mElapsedTime);
