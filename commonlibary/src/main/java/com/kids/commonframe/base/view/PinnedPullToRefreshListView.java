...
public class  PinnedPullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public PinnedPullToRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PinnedPullToRefreshListView(Context context, Mode mode) {
		super(context, mode);
	}

	public PinnedPullToRefreshListView(Context context, Mode mode, AnimationStyle style) {
	 ...
	 * @param minPagerSize
	 */
	public void setMinPageSize(int minPagerSize) {
		this.MIN_DATA_SEIZE = minPagerSize;
	}
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		LoadingLayout origLoadingView = null , listViewLoadingView, oppositeListViewLoadingView = null;
...
//				origLoadingView = getFooterLayout();
	...
	protected final int getFooterSize() {
		return mFooterLoadingView.getHeight();
	}
	...
	protected void onReset() {
	 ...
	 LoadingLayout originalLoadingLayout = null , listViewLoadingLayout;
...
//				originalLoadingLayout = getFooterLayout();
	...
	protected void onPullToRefresh() {
		...
		mFooterLoadingView.pullToRefresh();
		}
	}
	...
	protected void onReleaseToRefresh() {
		...
		if ( Mode.PULL_FROM_END == this.getCurrentMode()) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PinnedPullToRefreshListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
	...
	protected class InternalListView extends PinnedSectionListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			PinnedPullToRefreshListView.this.setEmptyView(emptyView);
		}
	...
	private void setPullListViewModel () {
		if ( currentMode != null  ) {
			switch (currentMode) {
			case BOTH:
