...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void addCancleButton(){
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,152);
		...
		buttonLayout2.addView(lineView);
	...
	public final void showEditPage(final Platform platform) {
		...
		if (TextUtils.equals(platform.getName(), SinaWeibo.NAME) && !TextUtils.isEmpty((String)shareParamsMap.get("titleUrl"))) {
			shareParamsMap.put("text",(String)shareParamsMap.get("text") + (String)shareParamsMap.get("titleUrl"));
		}
